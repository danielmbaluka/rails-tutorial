...
class DispatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dispatch" do
    assert_difference('Dispatch.count') do
      post dispatches_url, params: { dispatch: { amount: @dispatch.amount, customer: @dispatch.customer, description: @dispatch.description, dispatch_date: @dispatch.dispatch_date, driver: @dispatch.driver, status: @dispatch.status, vehicle: @dispatch.vehicle } }
    end
  ...
  test "should update dispatch" do
    patch dispatch_url(@dispatch), params: { dispatch: { amount: @dispatch.amount, customer: @dispatch.customer, description: @dispatch.description, dispatch_date: @dispatch.dispatch_date, driver: @dispatch.driver, status: @dispatch.status, vehicle: @dispatch.vehicle } }
